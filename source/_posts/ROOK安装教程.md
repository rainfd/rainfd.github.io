...
title: ROOK安装教程
filename: ROOK安装教程
typora-copy-images-to: ROOK安装教程
date: 2020-11-13 22:36:39
tags:
categories:
 - k8s
---
...
如何发现osd的数量不对，可以参考这个https://rook.io/docs/rook/v1.4/ceph-common-issues.html#osd-pods-are-not-created-on-my-devices 看看是什么问题导致的。
