...
date: 2019-05-18 09:10:38
tags: 
  - Devops
categories: 
  - 成为DevOps工程师
typora-copy-images-to: 成为DevOps工程师-配置Git篇
---

{% img git https://cn.bing.com/th?id=OIP.B-a2W-OEiR4pZistagWjmQHaDt&pid=Api&rs=1&p=0 300 20 %}
...
{% asset_img vs-git.png %}

在许多IDE上，也会自动集成Git的插件。

#### Gitlab graph

{% asset_img gitlab_tree.png %}
